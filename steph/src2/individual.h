...
extern individual_t individual_mk(pool_t *p_pool, graph_t *p_g, bvector_t *p_bvector);
...
extern individuals_t individual_crossing(pool_t *p_pool, graph_t *p_g, individual_t individual1, individual_t individual2);

extern individual_t individual_drop_out(pool_t *p_pool, graph_t *p_g, individual_t individual, double probability);

extern individual_t individual_insert(pool_t *p_pool, graph_t *p_g, individual_t individual, double probability);
