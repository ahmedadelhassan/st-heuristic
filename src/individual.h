...
extern individual_t individual_copy(pool_t *p_pool, individual_t individual);
...
extern individual_t individual_alter(pool_t *p_pool, graph_t *p_graph, individual_t individual, double probability);
